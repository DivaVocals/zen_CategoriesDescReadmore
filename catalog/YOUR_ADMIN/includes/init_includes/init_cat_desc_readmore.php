...
$module_constant = 'CAT_DESC_READMORE_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/cat_desc_readmore'; // This is the directory your installer is in, usually this is lower case
$module_name = "Categories Read More Description"; // This should be a plain English or Other in a user friendly way
